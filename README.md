...
```
git clone https://github.com/marik177/api_yamdb
```
...
Полная документация ([redoc.yaml](https://github.com/marik177/api_yamdb/blob/main/app/static/redoc.yaml)) доступна по адресу http://0.0.0.0:8000/redoc/
...
Полная документация ([redoc.yaml](https://github.com/marik177/api_yamdb/blob/main/app/static/redoc.yaml)) доступна по адресу http://127.0.0.1:8000/redoc/
